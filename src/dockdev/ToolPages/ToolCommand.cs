    ...
    string id = "")
{
    ...
    /// anyone rewords a button. The ids here are the vocabulary <c>tests/dockdev.UITests</c> drives
    ...
    /// the app and <c>tests/dockdev.UITests</c> cannot drift apart without the compiler noticing.</summary>
