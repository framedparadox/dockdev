...
public sealed class CsvFormat : IDataFormat
{
    ...
    /// either, so this changes nothing about what dockdev can open; it changes what a file dockdev
    ...
    /// quote — the standard "force text" escape — even though dockdev itself never executes anything.
    /// </summary>
