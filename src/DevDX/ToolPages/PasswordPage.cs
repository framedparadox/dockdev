...
{
    private readonly NumberBox _length = new() { Value = 20, Minimum = 4, Maximum = 512, SpinButtonPlacementMode = NumberBoxSpinButtonPlacementMode.Compact, Width = 120 };
    private readonly NumberBox _count = new() { Value = 5, Minimum = 1, Maximum = 500, SpinButtonPlacementMode = NumberBoxSpinButtonPlacementMode.Compact, Width = 120 };
    ...
    public PasswordPage()
    {
        ...
        var classes = new StackPanel { Spacing = 6 };
        foreach (var box in new[] { _lower, _upper, _digits, _symbols, _excludeAmbiguous })
        {
