...
/// <see cref="DevDxManager"/>; this class knows only about its own <see cref="DockProfile"/>.
/// </para>
/// </summary>
public sealed partial class DockWindow : Window
{
    ...
    public DevDxManager Manager => _manager;
    ...
    /// </summary>
    internal const string WindowTitle = "DevDX";

    public DockWindow(DevDxManager manager, DockProfile profile, bool seedDefaults)
    {
        _manager = manager;
        _profile = profile;
    ...
    /// <see cref="DevDxManager.SetDensity"/>, since density is app-wide.</summary>
    ...
    /// <summary>
    /// Resolves the <see cref="ElementTheme"/> to request for any DevDX window given the chosen
    ...
    /// <see cref="DevDxManager.SetTheme"/>, since the theme is app-wide.</summary>
    ...
    // ---- Visibility (driven by the tray menu, via DevDxManager) -------------
