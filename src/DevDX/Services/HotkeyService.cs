...
/// <summary>
/// Registers DevDX's system-wide shortcuts with Windows and raises <see cref="Pressed"/> with the
...
/// id (see <c>DevDxManager</c>, which allocates them), and <c>WM_HOTKEY</c> is routed on the same
