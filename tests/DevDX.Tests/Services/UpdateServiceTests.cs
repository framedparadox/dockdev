...
/// <summary>
/// The update check is the only part of DevDX that reads data it did not produce, and the only
...
public class UpdateServiceTests
{
    ...
    [InlineData("http://github.com/framedparadox/dev-dx/releases/tag/v9")]
    [InlineData("https://github.com.evil.example/framedparadox/dev-dx")]
    [InlineData("https://evil.example/framedparadox/dev-dx")]
    ...
    [Theory]
    [InlineData("https://github.com/framedparadox/dev-dx/releases/tag/v1.2.0")]
    [InlineData("https://GitHub.com/framedparadox/dev-dx/releases/latest")]
    public void GenuineGitHubReleaseUrl_IsKept(string candidate)
    {
        ...
        Assert.Contains("dev-dx", result, StringComparison.Ordinal);
    }
