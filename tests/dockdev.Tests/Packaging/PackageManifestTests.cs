...
namespace dockdev.Tests.Packaging;
...
public class PackageManifestTests
{
    ...
    private static string ProjectPath => Path.Combine(SourceRoot, "dockdev.csproj");
    ...
    {
        // Design doc §29 risk 9 wonders whether dockdev needs runFullTrust at all. It does, and not
    ...
    public void NoBroadOrSensitiveCapabilityIsDeclared()
    {
        ...
        // listing. dockdev reads no location, no camera, no contacts, and — §21 — no arbitrary path.
        var forbidden = new[]
        {
