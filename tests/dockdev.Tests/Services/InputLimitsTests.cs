...
public class InputLimitsTests : IDisposable
{
    private readonly string _directory =
        Path.Combine(Path.GetTempPath(), "dockdev-inputlimits-" + Guid.NewGuid().ToString("N"));
    ...
    {
        // An icon is drawn at 44 px. The ceiling exists because this is the one place dockdev hands
